(function() {"use strict";var __module = CC_EDITOR ? module : {exports:{}};var __filename = 'preview-scripts/assets/Script/Game/Ball_old.js';var __require = CC_EDITOR ? function (request) {return cc.require(request, require);} : function (request) {return cc.require(request, __filename);};function __define (exports, require, module) {"use strict";
cc._RF.push(module, 'f0b8cOJaiJAsJgf2ie+VEXd', 'Ball_old', __filename);
// Script/Game/Ball_old.js
...
cc.Class({
    ...
    restData: function restData() {
        ...
        var abs = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : 1;
    ...
    collisionBoard: function collisionBoard(node) {
        ...
        this.scheduleOnce(function () {
            _this.restData(_this.floorNum, true, -1);
            _this.isBoard = false;
        }, 0.01);
    ...
    collisionOrc: function collisionOrc(node) {
        ...
        if (this.value >= 1) {
            this.bounce = 20;
            this.scheduleOnce(function () {
                if (!_this2.isBoard) _this2.restData();
            }, 0.01);
        } else {
            this.bounce = 10;
            this.floorNum = 10;
            this.scheduleOnce(function () {
                if (!_this2.isBoard) _this2.restData(_this2.floorNum, false, -1);
            }, 0.01);
        }
...
cc._RF.pop();
        ...
        //# sourceMappingURL=Ball_old.js.map
