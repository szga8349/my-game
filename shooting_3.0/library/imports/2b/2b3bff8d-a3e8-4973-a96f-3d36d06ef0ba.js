"use strict";
cc._RF.push(module, '2b3bf+No+hJc6lvPTbQbvC6', 'game');
// Script/game/game.js
...
cc.Class({
    ...
    createProp: function createProp() {
        var type = parseInt(3 * Math.random()) + 1;
        // 随机派送一个道具
        var newProp = null;
        switch (type) {
            case 1:
        ...
        var _x = parseInt((this.blockBox.width - newProp.width * 2) * Math.random()) + 1 + newProp.width,
